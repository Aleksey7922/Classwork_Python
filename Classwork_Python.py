...
# def bold(fn): # декорирующая функция
#     def wrap():
#         return "<b>" + fn() + "</b>"
#
#     return wrap
#
#
# def italic(fn):  # декорирующая функция
#     def wrap():
#         return "<i>" + fn() + "</i>"
#
#     return wrap
...
#
#
# print(hello())  # декорируемая функция, выводит "text"  (<b><i>text</i></b>)

# Задача. Создайте декоратор, который будет выводить количество вызовов декорирующей функции и ее содержимое

# def cnt(fn):    # декорирующая функция (fn) - передали декорируемую функцию
#     count = 0 # создали переменную для счетчика
#
#     def wrap(): # вложенная функция
#         nonlocal count  # сделали переменную локальной
#         count += 1 # увеличили счетчик
#         fn() # вызов декорируемой функции
...
#
#
# hello() # вызов декорируемой функции
# hello()  # вызов декорируемой функции
# hello()  # вызов декорируемой функции

#  -----------------------------------------------------------------------------------------
# Описание. Декорируемая функция приходит в принимаемый аргумент наружней функции (fn), параметры функции приходят во
# вложенную функцию, и обязательно надо вызвать декорируемую функцию (fn) с ее параметрами. Декорируемая функция
# принимается в верхнюю функцию, параметры принимаются во вложенную функцию

# def args_decorator(fn):  # 3 создали наружную декорирующую функцию, и передали в нее декорируемую функцию
#     def wrap(arg1, arg2):  # 4 создали вложенную функцию, 8 передали параметры
#         print('Данные:')  # 5
#         fn(arg1, arg2)  # 7 вызвали декорируемую функцию
#
#     return wrap  # 6 вернули вложенную функцию
#
#
# @args_decorator  # 7 указали декоратор
# def print_full_name(first, last):  # 1 создали функцию, принимающую имя и фамилию
#     print('Меня зовут', first, last)
#
#
# print_full_name('Ирина', 'Мумладзе')  # 2 вызвали функцию, и передали параметры (имя фамилия)
# --------------------------------------------------------------------------

# def args_decorator(fn):  # наружная функция, передали в нее декорируемую функцию (fn)
#     def wrap(*args, **kwargs):  # декорирующая функция, с параметрами
#         print("args:", args)
#         print("kwargs:", kwargs)
#         fn(*args, **kwargs)  # вызвали декорируемую функцию
#
#     return wrap
#
#
# @args_decorator  # декорируем функцию
# def func(a, b, c, study="Python"):  # создали декорируемую функцию
#     print(a, b, c, "изучают", study, end="\n\n")
#
#
# func("Борис", "Елизавета", "Светлана", study="JavaScript")  # вызвали декорируемую функцию, и передали параметры
# func("Владимир", "Екатерина", "Виктор")  # вызвали декорируемую функцию, и передали параметры

# def args_decorator(fn):
#     def wrap(*args, **kwargs): #  декорирующая функция
#         print("args:", args)
#         print("kwargs:", kwargs)
#         fn(*args, **kwargs)
#
...
# def decor(fn):  # 4 создали наружную функцию
#     def wrap(x, y):  # 5 создали вложенную функцию, декорирующую
#         print("Сумма:", x, "и", y, '=', end=" ")
#         fn(x, y)  # 8 вызвали декорируемую функцию, и предали аргументы
#
#     return wrap  # 6 вернули вложенную функцию без вызова
#
#
# @decor # 7 задекорировали функцию
# def summa(a, b):  # 1 создали декорируемую функцию
#     print(a + b)  # 2
#
#
# summa(5, 2)  # 3 вызвали функцию, и передали параметры


# ---------------------------------------------------

# Описание. Если у декоратора есть параметры (может быть один, два, любое кол-во), тогда нужна третья дополнительная
# функция. Больше трех функций в декораторе не бывает. Параметры, которые приходят в декораторе, попадают в самую
# вложенную функцию, сама декорируемая функция попадает во вложенную функцию
#
# def decor_args(arg1,arg2):  # 11 создали еще одну наружную функцию, добавили параметры (действия)
#     def decor(fn):  # 4 создали наружную функцию
#         def wrap(x, y):  # 5 создали вложенную функцию, декорирующую
#             print(arg1, x, arg2, y, '=', end=" ")  # arg1,arg2 - принимаемые параметры (в зависимости от действия)
#             fn(x, y)  # 8 вызвали декорируемую функцию, и предали аргументы
#
#         return wrap  # 6 вернули вложенную функцию без вызова
#
#     return decor  # 12 вернули наружную функцию, которая стала вложенной без вызова
#
#
# @decor_args('Сумма:', "+")  # 7 задекорировали функцию, 13 изменили декор согласно наружней функции
# def summa(a, b):  # 1 создали декорируемую функцию
#     print(a + b)  # 2
#
#
# @decor_args('Разность:', "-")  # 14 задекорировали функцию, изменили декор согласно наружней функции
# def sub(a, b):  # 9 создали еще одну декорируемую функцию
#     print(a - b)
#
#
# summa(5, 2)  # 3 вызвали функцию, и передали параметры
# sub(5, 2)  # 10 вызвали функцию, и передали параметры
...
# Вторым параметром в int() указываем нужную систему счисления -----------
# print(int("100", 2))  # 4
# print(int("100", 8))  # 64
...
# print(bin(18))  # 0b10010 - двоичная, bin() - функция преобразования в числа в нужную систему счисления
# print(oct(18))  # 0o22 - восьмеричная, oct() - функция преобразования в числа в нужную систему счисления
# print(hex(18))  # 0x12 - шестнадцатеричная, hex() - функция преобразования в числа в нужную систему счисления
# #
#
...
# print(e)
# print(e * 2)
# print("y1" in e)  # проверка, есть ли указанный символ в указанной строке (true или false)
# print(e[0])  # обращение к строке по индексу
# print(e[1:3]) # обращение к строке по срезу
...
#
# print("Привет")
# print(u"Привет")  # u - префикс для поддержки русского кода

# print("C:\\folder\\fil\nes.txt\\")
# print(r"C:\folder\files\\"[:-1])  # r - префикс для экранирования
# print(r"C:\folder\files" + "\\")   # r - префикс для экранирования

# name = "Дмитрий"
# age = 25
# print("Меня зовут " + name + ". Мне " + str(age) + " лет.")
# print(f"Меня зовут {name}. Мне {age} лет.")  # префикс f
...
# Тройные кавычки поддерживают многострочный текст (переносят текст)
...
# def square(n):
#     # """Принимает число n, возвращает квадрат числа n."""   # комментарий к функции
#     print()
#     return n ** 2


# print(square(5))
# print(square.__doc__)  # отображение описания функции -----------------------------------
# # max(5, 5)
# # len()
# print(len.__doc__)
# print(min.__doc__)
...
# print(ord('a'))  # просмотр кода символа через функцию ord()
# print(ord('#'))
# print(ord('й'))
...
# print(chr(97))  # отображение символа по коду , функция chr() ---------------------------
# print(chr(8364))
...
# from random import randint  # генератор случайных чисел
#
# Генерируем пароль

# shortest = 7  # минимальная длина пароля
# longest = 16  # максимальная длина пароля
# min_ascii = 33 # от 33
# max_ascii = 126  # до 126
#
#
# def random_password(): # создали функцию
#     res = ""  # создали переменную для хранения пароля
#     for i in range(randint(shortest, longest)):  # range(10)
#         rand_char = chr(randint(min_ascii, max_ascii)) # переменная принимает случайное значение из диапазона
#         res += rand_char
#     return res # возвращаем переменную с паролем
#
#
# print("Ваш случайный пароль:", random_password())  # вызвали функцию

# Методы строк ---------------------------------------------------------------------------------------------

# s = "hello, WORLD! I am learning Python."
# # print(s.capitalize())  # Hello, world! i am learning python. - символы в нижнем регистре,кроме первого
# # print(s.lower())  # hello, world! i am learning python. - все символы в нижнем регистре
# # print(s.upper())  # HELLO, WORLD! I AM LEARNING PYTHON. все символы в верхнем регистре
# # # print(s.swapcase())  # HELLO, world! i AM LEARNING pYTHON.
# # # print(s.title())  # Hello, World! I Am Learning Python. - каждое слово  с верхнего регистра
# # print(s)
#
# # print(s.count("l")) # кол-во указанных символов в строке
# # print(s.count("l", 3)) # кол-во указанных символов в строке, с указанного символа
# # print(s.count("l", 3, 10)) # кол-во указанных символов в строке, с указанного индекса до указанного индекса
#
# # print(s.find("Python1"))  # возвращает индекс первого вхождения подстроки в строку, если такой подстроки нет
# # # возвращает "-1"
# # # print(s.find("l", 4, 20)) # возвращает индекс  с указанного индекса до указанного индекса,если такой подстроки нет
# # # # возвращает "-1"
# # print(s.find("l"))
# # print(s.rfind("l"))  # возвращает индекс последнего вхождения подстроки в строку
# #
# # print(s.index("l"))  # если указанного элемента нет, выходит исключение - ValueError
# # print(s.rindex("l"))
#
# Задача.Дана строка, состоящая ровно из двух слов, разделенных пробелом. Переставьте эти слова местами.
# Результат запишите в строку и выведите получившуюся строку.
#
# st = input("Введите два слова через пробел: ")
# first = st.find(" ")  # вывели индекс символа пробел
# print(first)
# first = st[:st.find(" ")]  # взяли срез от начала до символа пробел
# second = st[st.find(" ") + 1:]
# print(second + " " + first)
#
# s = "hello, WORLD! I am learning Python."
#
# print(s.startswith("I am", 14))  # .startswith() - проверяем, начинается ли строка с указанных символов (True,false)
# print(s.index("I am"))  # индекс
# print(s.endswith("on."))  # .endswith() - проверяем, заканчивается ли строка с указанными символами (True,false)

# print(int("789"))

# print('123'.isdigit())  # проверяем явл-ся ли элементы в строке только числами (True,false)
# print('qЙwee'.isalpha())  # проверяем явл-ся ли элементы в строке только буквами (True,false)
#
...
# if n.isdigit():  # проверяем, что ввели только числа
#     n = int(n)
#     print(n * 2)


# print('py'.center(10))  # метод для консоли (выравнивание по центру на 10 символов)
# print(' py '.center(11, "-"))  # "-" - второй параметр(заполнение)


# print('    py    '.lstrip()) # .lstrip() - удаляет пробелы с левой стороны
# print('    py    '.rstrip()) # .rstrip() - удаляет пробелы с правой стороны
# print('    p y    '.strip()) # .strip() - удаляет пробелы с обоих сторон
#
# print('https://www.pythons.org'.strip('/:pths.org'))  # удалили указанные в () символы с обеих сторон (при выводе)
# print('https://www.pythons.org'.lstrip('/:pths').rstrip('.org'))  # удалили указанные в () с лева и справа

# str1 = "Я изучаю Nython. Мне нравится Nython. Nython очень интересный язык программирования. New"
# print(str1.replace("Nython", "Python"))  # .replace() - заменяет значение
# print(str1.replace("N", "P"))

#
# s = "-"
# seq = ("a", "b", "c")
# print(s.join(seq)) # .join() -  объединяет список, кортеж в одну строку c указанным разделительным элементом,
# работает только со строками

# print("..".join(['1', '99'])) # .join() - объединяет список, кортеж в одну строку c указанным разделительным элементом
#
# print(", ".join("Hello")) # .join() - объединяет список, кортеж в одну строку c указанным разделительным элементом
#
# print("Строка разделенная пробелами".split())  # ['Строка', 'разделенная', 'пробелами']
# print('www.python.org.ru'.split(".", 2))  # разбивает строку
# print('www.python.org.ru'.rsplit(".", 2))

# a = input("-> ").split()  # возвращает список из введенных через пробел элементов
# b = list(map(int, a))
# print(b)
...
# import re  # импортировали модуль для работы с шаблонами регулярных выражений
#
# s = "Я ищу совпадение в 2024 году. И я их найду в 2 счёта."
# reg = "а"  # в переменной reg будет шаблон регулярного выражения
#
# print(re.findall(reg, s))  # возвращает список содержащий все совпадения c шаблоном,
# # если совпадения нет, возвращает пустой список
#
# # print(re.search(reg, s))  # расположение первого совпадения с объектом <re.Match object; span=(10, 11), match='а'>
# # print(re.search(reg, s).span())  # индекс начала совпадения, и индекс где заканчивается
# # print(re.search(reg, s).start())  # индекс начала совпадения
# # print(re.search(reg, s).end())  # индекс конца совпадений
...
# reg = "[А-яЁё]"  # [А-яЁё] - диапазон поиска совпадений русский алфавит
# reg = "[A-Za-z]"  # [A-Za-z] - диапазон поиска совпадений латинский алфавит
# reg = r"\."  # Поиск точки ... в квадратных скобках действие спецсимвола теряется
# reg = r"[A-Za-z\[\]-]" # если нужно найти дефис - его ставят в самом конце
# reg = r"[^0-9]" # [^...] - будет показывать все что угодно, только не цифры
# reg = r"[^А-яЁёA-Za-z0-9]" # [^...] - будет показывать все что угодно, только не буквы
# print(re.findall(reg, s))


#
# print(ord('Я'))  # выводим код символа
# print(ord('а'))  # выводим код символа
...
# Флаги _______________________________________________________
...
# reg = "я"
#
# print(re.findall(reg, s, re.IGNORECASE))  # re.IGNORECASE - флаг проверка без учета регистра символов
...
# print(re.findall(r"one$", text, re.MULTILINE)) #  re.MULTILINE - флаг для многострочных текстов

# print(re.findall('''
# [A-Za-z0-9._-] +   # part 1
# @                  # @
# [A-Za-z.-]+        # part 2
# ''', 'test@mail.ru', re.VERBOSE)) # re.VERBOSE - позволяет использовать переносы и комментарии в регулярных выражениях

# text = """Python, # строка
# python,
# PYTHON"""
#
# reg = "(?mi)^python" # в шаблон можно вставлять флаги(i-игнор регистра,m-многострочный) в сокращенном написании
# print(re.findall(reg, text))

# text = "<body>Пример жадного соответствия регулярных выражений</body>"
# print(re.findall("<.*?>", text))  # ищем тег <body></body>

# +?, *?, ?? _________________________________________________________________________
# {m,n}?, {,n}?, {m,}?________________________________________________________________

# s = "12 сентября 2024 года 568789456"
# reg = r"\d{2,4}?"
# print(re.findall(reg, s))

# s = "Ольга и Виталий отлично учатся!"  # создали строку
# reg = "Петр|Ольга|Виталий"  # создали шаблон поиска, символ(|) значит - или
# print(re.findall(reg, s))  # предали строку(s) и шаблон(reg)
...
# s = "5 + 7*2 - 4"  # создали строку
# reg = r"\s*([+*-])\s*"  # круглые скобки() захватывают все, что в них попадает, знак (?:...) отменяет это
# print(re.split(reg, s))  # re.split()- разбивает строку на элементы массива -['5', '+', '7', '*', '2', '-', '4']

# Задача. Попросите пользователя ввести текущую дату по заданному шаблону и проверьте данные на соответствие

# s = "01-12-2024"  # создали строку
# reg = "(0[1-9]|[12][0-9]|3[01])-(0[1-9]|1[0-2])-(19[0-9][0-9]|20[0-9][0-9])"  # создали шаблон для поиска
# # print(re.findall(reg, s))
# # print(re.search(reg, s).group())
# m = re.search(reg, s)  # сохранили (re.search(reg, s) в переменную m
# print(m[0])  # возвращает весь шаблон целиком - 01-12-2024
# print(m[1])  # возвращает содержимое первых скобок - 01
# print(m[2])  # возвращает содержимое вторых скобок - 12
# print(m[3])  # возвращает содержимое третьих скобок - 2024
# print(re.search(reg, s).group())
...
# reg = r"(\d{2})/(\d{2})/(\d{4})"
# print(re.sub(reg, r"\2.\1.\3", s))  # поменяли местами значения в круглых скобках
...
#         return
#     print("=>", n)  # 1
#     elevator(n - 1)  # 5 4 3 2 1  # условие перемены (шаг)
#     print(n, end=" ")
#
#
...
# Сумма элементов
# def sum_list(lst):  # создали функцию
#     res = 0  # переменная для записи результата
#     for i in lst:  # проходим циклом по списку
#         res += i  # сумма элементов списка
#     return res  # возвращаем результат
#
#
# print(sum_list([1, 3, 5, 7, 9]))  # 25 # вызываем функцию

# Сумма элементов - РЕКУРСИЯ
# def sum_list(lst):  # [9]
#     if len(lst) == 1:
